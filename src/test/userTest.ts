...
const data1 : dataUser = {
    ...
    lvlActivity: 3,
    courses: [],
    food: {breakfast:[],dinner:[],lunch:[],recommendedCalorie:{breakfast:{calories:400,carbs:20,fat:20,protein:50},dinner:{calories:400,carbs:20,fat:20,protein:50},lunch:{calories:400,carbs:20,fat:20,protein:50}}},
    history: [],
    test: {
